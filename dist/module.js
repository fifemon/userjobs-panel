                ...
                _createClass(UserJobsCtrl, [{
                    ...
                    value: function onDataReceived(data) {
                        if (data) {
                            ...
                            this.data = response.aggregations.jobs.cluster.buckets.concat(response.aggregations.dags.cluster.buckets);
                            this.docsMissing = response.aggregations.jobs.cluster.sum_other_doc_count + response.aggregations.dags.cluster.sum_other_doc_count;
                    ...
                    value: function link(scope, elem, attrs, ctrl) {
                        ...
                        function renderActiveRow(data) {
                            ...
                            if (panel.showRequests) {
                                ...
                                html += '<td>' + max_mem.toFixed(0) + '&nbsp;&nbsp;&nbsp;&nbsp;</td>' + '<td>' + max_disk.toFixed(0) + '&nbsp;&nbsp;&nbsp;&nbsp;</td>' + '<td>' + max_walltime.toFixed(0) + '&nbsp;&nbsp;&nbsp;&nbsp;</td>';
                            }
                            html += '<td>' + efficiency + '</td>' + '<td>' + data.max_restarts.value + '&nbsp;&nbsp;&nbsp;&nbsp;</td>' + '</tr>';
                            if (panel.mode === 'Active') {
